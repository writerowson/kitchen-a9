    ...
    return (
        <div>
            ...
            <ul className='text-start container mb-5'>
                ...
                <li><b>Example - </b> Header, main, section,  div, footer are example of block element tag. Span,small, script, input, br,a, img this are example of inline element  </li>

            </ul>

            <h4 style={{ color: 'RGB(220,77,1)' }}>The defination of symentic tag </h4>
            <p className='text-start container mb-5'>In HTML all tags are not so easy to understand literally. But HTML5 try to make it easy. In HTML5 which tags are meaningful for both developer and browser those are known as symentic tag. As example article, header, footer are consider as symantic tag those are actually use as their meaning. To understand this tags nobody needs to become developer. </p>
        </div>
    );
};
